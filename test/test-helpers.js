...
function makeExpectedThing(users, thing, reviews=[]) {
  ...
  return {
    ...
    date_created: new Date(thing.date_created).toLocaleDateString(),
    number_of_reviews,
    ...
    user: {
      ...
      date_created: new Date(user.date_created).toLocaleDateString(),
    },
  }
}
  ...
  return expectedReviews.map(review => {
    ...
    return {
      ...
      user: {
        ...
        date_created: new Date(reviewUser.date_created).toLocaleDateString(),
      }
    }
  })
}
