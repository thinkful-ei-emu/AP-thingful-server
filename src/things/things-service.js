...
const ThingsService = {
  ...
  serializeThing(thing) {
    ...
    thingData.user.date_created = new Date(thingData.user.date_created).toLocaleDateString()

    return {
      id: thingData.id,
      title: xss(thingData.title),
      content: xss(thingData.content),
      date_created: new Date(thingData.date_created).toLocaleDateString(),
  ...
  serializeThingReview(review) {
    ...
    reviewData.user.date_created = new Date(reviewData.user.date_created).toLocaleDateString()
    return {
      id: reviewData.id,
      ...
      date_created: new Date(reviewData.date_created).toLocaleDateString(),
    }
  },
}
